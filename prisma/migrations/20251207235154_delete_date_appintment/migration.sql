...
INSERT INTO "new_Appointment" ("clinicLocationId", "createdAt", "doctorId", "endTime", "id", "patientId", "startTime", "status", "updatedAt") SELECT "clinicLocationId", "createdAt", "doctorId", "endTime", "id", "patientId", "startTime", "status", "updatedAt" FROM "Appointment";
